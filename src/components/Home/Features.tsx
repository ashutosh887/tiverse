...
function Features() {
  return (
    ...
    <h1 className="mt-8 mb-12 text-3xl font-bold">Features</h1>

    <div className="flex flex-wrap items-center justify-between w-full space-y-4 text-center">
      {features.map(({title, icon}, idx: number) => (
        <div key={idx} className="flex flex-col w-[30%] space-y-6 items-center mx-4 my-8 p-2 text-gray-300 hover:text-blue-500 ctransition cursor-pointer">
          {icon}
